"""
Evaluation harness for filesystem-mcp-with-FastMCP-server.
...
def run_evaluation():
    print("Running evaluation harness for filesystem-mcp-with-FastMCP-server...")
    ...
    results = {
        "project": "filesystem-mcp-with-FastMCP-server",
        "timestamp": time.time(),
